...
//                     ),
//                     Text(
//                       "Enter details of the item lost:",
//                       style:
...
//                       //     height: 60,
//                       //     //color: Theme.of(context).colorScheme.secondary,
//                       //     child: Center(child: Text("FETCH LOCATION")),
//                       //   ),
//                       // ),
//                       SizedBox(
//                         height: 16,
//                       ),
//                       // Text("Location : $foundItemLocation"),
//                       // SizedBox(
//                       //   height: 16,
//                       // ),
//                       Row(
...
//   image = ( _imagePicker.pickImage(source: ImageSource.gallery)) as PickedFile?;
...
class _ReportLostPageState extends State<ReportLostPage> {
  ...
  void initState() {
    super.initState();
    reportNo = Random().nextInt(10000).toString();
  }
  ...
  Future<void> uploadFoundReport() async {
    if (_reportFoundForm.currentState!.validate()) {
      await FirebaseFirestore.instance.collection("lostReport").doc(reportNo).set({
        "reportNumber": reportNo,
        "createdAt": FieldValue.serverTimestamp(),
        "createdBy": FirebaseAuth.instance.currentUser?.email,
        "reportLocation": foundItemLocation,
        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                SizedBox(height: 30),
                Text("Report Lost Item", style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold)),
                SizedBox(height: 6),
                Text("Enter details of the item lost:", style: TextStyle(fontSize: 18, color: Colors.grey.shade400)),
                SizedBox(height: 26),
                Row(
                  children: [
