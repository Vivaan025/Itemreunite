...
//   String reportNo = '';
//   String itemCategory = '';
//   String foundItemLocation = 'New York, USA'; // Hardcoded location
//   double? foundItemLatitude = 40.7128; // Hardcoded latitude
//   double? foundItemLongitude = -74.0060; // Hardcoded longitude
...
//   Future<void> uploadFoundReport() async {
//     if (_reportFoundForm.currentState!.validate() && foundItemLocation.isNotEmpty) {
//       await FirebaseFirestore.instance
//           .collection("foundReport")
//           .doc(reportNo)
//           .set({
...
//               children: <Widget>[
//                 SizedBox(height: 30),
//                 Text("Report Found Item", style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold)),
//                 SizedBox(height: 6),
//                 Text("Enter details of the item found:", style: TextStyle(fontSize: 18, color: Colors.grey.shade400)),
//                 SizedBox(height: 26),
//                 Row(
//                   children: [
//                     Text("Report Number: ", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
//                     SizedBox(width: 10.0),
//                     Text("#$reportNo", style: TextStyle(fontSize: 16)),
//                   ],
//                 ),
...
//                         decoration: InputDecoration(
//                           labelText: "Item Name",
//                           labelStyle: TextStyle(fontSize: 16, color: Theme.of(context).colorScheme.secondary),
...
//                           SizedBox(width: 10.0),
//                           Expanded(
//                             child: Text("$foundItemLocation", style: TextStyle(fontSize: 16)),
//                           ),
//                         ],
//                       ),
//                       SizedBox(height: 16),
...
//                         child: TextButton(
//                           onPressed: () {},
//                           child: Text("Fetch Location", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white)),
//                         ),
//                       ),
//                       SizedBox(height: 16),
//                       Row(
//                         crossAxisAlignment: CrossAxisAlignment.center,
//                         children: <Widget>[
//                           Text("Item Category:", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
//                           SizedBox(width: 20.0),
//                           DropdownButton(
//                             value: dropDownValue,
//                             items: [
//                               DropdownMenuItem(child: Text("Documents"), value: 0),
//                               DropdownMenuItem(child: Text("Valuables"), value: 1),
//                               DropdownMenuItem(child: Text("Electronics"), value: 2),
...
//                                   height: 150,
//                                   width: 150,
//                                   child: Center(child: Text("Upload Photo", style: TextStyle(fontSize: 15.0, color: Colors.white))),
//                                 )
//                           : Container(),
//                       SizedBox(height: 16),
//                       Container(
...
//                               child: Text("Add Image (Optional)", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
//                             ),
//                           ),
//                         ),
//                       ),
...
//                               alignment: Alignment.center,
//                               constraints: BoxConstraints(minHeight: 50, maxWidth: double.infinity),
//                               child: Text("Confirm Report", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Colors.white)),
//                             ),
//                           ),
//                         ),
//                       ),
...
class _ReportFoundPageState extends State<ReportFoundPage> {
  ...
  Future<void> uploadFoundReport() async {
    if (_reportFoundForm.currentState!.validate()) {
      await FirebaseFirestore.instance.collection("foundReport").doc(reportNo).set({
        "reportNumber": reportNo,
        "createdAt": FieldValue.serverTimestamp(),
        "createdBy": FirebaseAuth.instance.currentUser?.email,
        "reportLocation": "New York, USA", // Hardcoded location
        "reportLongitude": -74.0060, // Hardcoded longitude
        "reportLatitude": 40.7128, // Hardcoded latitude
        "itemName": _foundItemNameController.text,
        "itemDescription": _foundItemDescController.text,
        "itemImage": photoUrl,
        "itemCategory": getCategory(dropDownValue),
  ...
  Future<void> addReportPhoto() async {
    ...
    if (image != null) {
      var snapshot = await _firebaseStorage.ref().child('foundReport').child("$randomInt").putFile(file);
      var downloadUrl = await snapshot.ref.getDownloadURL();
      setState(() {
        photoUrl = downloadUrl;
        _showImagePreview = true;
